...
--CREATE INDEX owner_shopping_cart ON shopping_cart(person_id);
--CREATE INDEX productid_in_cart ON products_in_cart(product_id);
CREATE INDEX cartid_of_cart ON products_in_cart(cart_id);
--CREATE INDEX state_index ON person(state_id);
--CREATE INDEX category_index ON product(category_id);
